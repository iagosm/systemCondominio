...
<template>
  ...
  <Head title="Adicionar Permissões" />
      ...
      <form @submit.prevent="form.post(route('roles.store'))" class="space-y-6 mt-4 max-w-md mx-auto">
        ...
        <div class="grid gap-2">
          ...
          <label v-for="permission in permissions"
            ...
            <input :value="permission" v-model="form.permissions" type="checkbox" class="form-checkbox h-5 w-5 text-blue-600 rounded focus:ring-2">
